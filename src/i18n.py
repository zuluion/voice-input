...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "lbl_local_framework_status": "本地推理引擎:",
        "local_model_ready": "✅ 已就绪",
        "local_model_missing": "⚠️ 未下载",
        "local_framework_installed": "✅ Ollama 免编译引擎已就绪 (~/.voiceinput/bin/)",
        "local_framework_missing": "⚠️ 未安装 Ollama 免编译引擎",
        "btn_install_framework": "⚡ 自动安装 Ollama 引擎",
        "confirm_download_model_title": "确认下载本地模型",
        "confirm_download_model_msg": "是否确认下载以下本地大模型？\n\n模型 ID: {model_id}\n文件大小: {size_str}\n\n(若在设置中开启了代理，将自动通过代理下载)",
        "confirm_install_framework_title": "自动安装 Ollama 本地引擎",
        "confirm_install_framework_msg": "是否立即自动下载并配置免编译的 Ollama 独立引擎至 ~/.voiceinput/bin/？\n\n(无需 Visual Studio C++ 编译器、无需 pip 编译，100% 零门槛秒级可用)",
    ...
    "en_US": {
        ...
        "lbl_local_framework_status": "Local Engine:",
        "local_model_ready": "✅ Ready",
        "local_model_missing": "⚠️ Not Downloaded",
        "local_framework_installed": "✅ Ollama Engine Ready (~/.voiceinput/bin/)",
        "local_framework_missing": "⚠️ Ollama Engine Missing",
        "btn_install_framework": "⚡ Auto Install Ollama Engine",
        "confirm_download_model_title": "Confirm Model Download",
        "confirm_download_model_msg": "Do you want to download the following local LLM model?\n\nModel ID: {model_id}\nSize: {size_str}",
        "confirm_install_framework_title": "Install Ollama Engine",
        "confirm_install_framework_msg": "Do you want to automatically download and setup the standalone Ollama engine to ~/.voiceinput/bin/?\n\n(No C++ compiler or pip build required)",
